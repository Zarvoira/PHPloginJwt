$(document).ready(function () {
    ...
    /*	when page is load successfully then there i s a list of categories when user click on category we will get category id and 
    ...
    function detailedproduct() {
        ...
        let id = parseInt(params.get('product'));
        $.ajax({
            dataType: "json",
            url: "getDetailedProduct.php",
            method: "POST",
            data: {product: id},
            success: function (data) {
                console.log(data);
                let html = '<div class="site-section">\n\
<div class="container"><div class="row">\n\
  <div class="col-lg-6">          \n\
  <img src="' + data.product_image + '" alt="" class="img-fluid">   \n\
       </div>       \n\
   <div class="col-lg-6">     <div class="row">  <div class="col-md-12 col-xs-12" id="product_msg">  </div>  </div>       \n\
   <h2 class="text-black">' + data.product_title + '</h2>    \n\
    <p><strong class="text-primary h4">€'+ data.product_price +'</strong></p>          \n\
<p><a href="cart.php" pid='+ data.product_id +' id="product" class="buy-now btn btn-sm btn-primary">Add To Cart</a></p>          </div>  </div>      </div>      </div>    </div> ';
                
                $("#getDetailedProduct").html(html);
            }
        })
    }
